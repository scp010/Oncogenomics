...
shinyUI(fluidPage(
  ...
  mainPanel(
    tabsetPanel(
      id="panel",
      tabPanel("Patient General Data", value=1, DT::dataTableOutput("generalTable"), downloadButton("downloadData1","Download Patient General Data")),
      tabPanel("Patient Specimen Data", value=2, DT::dataTableOutput("specimenTable"), downloadButton("downloadData2","Download Patient Specimen Data")),
      tabPanel("Specimen Data Table", value=3, DT::dataTableOutput("dataTable"), downloadButton("downloadData3","Download Specimen Data")),
